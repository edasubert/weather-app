export default {
  ...
  comp: {
    ...
    sameTemp: 'Temperatura media similar',
    warmer: 'Media {{diff}} más cálida',
    cooler: 'Media {{diff}} más fría',
    feelsSame: 'Sensación media similar',
    feelsWarmer: 'Sensación media {{diff}} más cálida',
    feelsCooler: 'Sensación media {{diff}} más fría',
    noRain: 'Sin lluvia',
